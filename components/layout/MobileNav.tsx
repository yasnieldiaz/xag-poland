...
const externalLinks = [
  { nameKey: "academy", href: "https://academy.droneagri.pl" },
];
      ...
      >
        ...
        <nav className="space-y-2">
          ...
          {externalLinks.map((link) => (
            <div key={link.nameKey} className="border-b border-gray-100">
              <a
                href={link.href}
                target="_blank"
                rel="noopener noreferrer"
                onClick={handleClose}
                className="flex items-center justify-between w-full py-4 text-lg font-semibold text-navy hover:text-brand-red transition-colors"
              >
                {t(link.nameKey)}
